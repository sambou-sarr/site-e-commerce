<?php 
     ...
     if(isset($_POST['libelle']) && isset($_POST['qute']) && isset($_POST['prix'])  && isset($_POST['img']) && isset($_POST['categorie']) ){
        ...
        $prix = $_POST['prix'];
    try {
        $sql= "INSERT INTO produit  (id_prod ,id_categorie ,lib_prod ,qte_en_stock ,prix_prod ,img_prod ) VALUES (null,? ,? ,? ,? ,?)";
        $prepare = $db->prepare($sql);
        $prepare->execute([$categorie, $libelle, $quantite, $prix,$image ]);
